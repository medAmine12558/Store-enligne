...
const Footer = () => {
  return (
    <Box sx={{ backgroundColor: 'rgb(34, 41, 53)',color:"#cfd3d7", padding: '20px', marginTop: 'auto' }}>
      <Grid container spacing={4} justifyContent="center">
        ...
        <Grid item xs={12} md={4}>
          ...
          <Typography variant="body2">Sidi Bernoussi, casablanca</Typography>
      ...
      <Box textAlign="center" marginTop="20px" >
        <Typography variant="body2" color="textSecondary" sx={{color:"#cfd3d7"}}>
